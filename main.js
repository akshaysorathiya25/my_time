...
const calc = () => {
  ...
  const effectiveHours = parseInt(document.getElementById("effectiveH").value);
  ...
  let remainingHours = 8.5 - effectiveHours + lastHours;
  ...
  let hrPositionNew =
    (remainingHours * 360) / 12 + (remainingMin * (360 / 60)) / 12;
